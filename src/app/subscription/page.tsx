...
export default function SubscriptionPage() {
  ...
  const [formDataToConfirm, setFormDataToConfirm] = useState<any | null>(null);
  ...
  const handleOpenConfirmDialog = useCallback(
    (formData: any, calculatedPrice: number) => {
  ...
  const handleSubmitSubscription = useCallback(async (formData: any) => {
    setLoading(true);
